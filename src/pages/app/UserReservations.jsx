                            ...
                            <div className="resCard" key={r.id}>
                                ...
                                <div className="resCard__body">
                                    {horarios.length === 0 ? (
                                        ...
                                        <details className="resDetails">
                                            <summary className="resSummary">
                                                <span>Ver franjas ({horarios.length})</span>
                                                <span className="resChevron">▾</span>
                                            </summary>
                                            ...
                                            <div className="resSlots">
                                                {horarios
                                                    ...
                                                    .map((h) => (
                                                        <div
                                                            className="resSlot"
                                                            key={h.horario_reserva_id ?? `${r.id}-${h.horario_id}`}
                                                        >
